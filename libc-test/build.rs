...
fn do_ctest() {
    match &env::var("TARGET").unwrap() {
        ...
        t if t.contains("linux") && !t.contains("wasm32") => return test_linux(t),
        t if t.contains("linux") && t.contains("wasm32") => return test_wali(t),
...
fn test_wali(target: &str) {
    ...
    cfg.skip_const(move |name| {
        ...
        match name {
            ...
            // FIXME: Not defined in WALI
            "SYS_clone3" => true,

            // FIXME: Not defined in WALI.
            "SYS_memfd_secret" => true,
            ...
            // FIXME: Not currently available in headers on ARM and musl.
            "NETLINK_GET_STRICT_CHK" if musl => true,
    ...
    cfg.skip_fn(move |name| {
        ...
        match name {
            ...
            // Needs glibc 2.34 or later.
            "posix_spawn_file_actions_addclosefrom_np" if gnu => true,
            // Needs glibc 2.35 or later.
            "posix_spawn_file_actions_addtcsetpgrp_np" if gnu => true,
