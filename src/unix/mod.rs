...
s! {
    ...
    pub struct timespec {
        pub tv_sec: time_t,
        #[cfg(all(musl_time64, target_endian = "big"))]
        __pad0: u32,
...
extern "C" {
    ...
    #[cfg_attr(musl_time64, link_name = "__utime64")]
    ...
    #[cfg_attr(musl_not_time64, allow(deprecated))]
    #[cfg_attr(musl_time64, link_name = "__mktime64")]
    pub fn mktime(tm: *mut tm) -> time_t;
    #[cfg_attr(target_os = "netbsd", link_name = "__time50")]
    #[cfg_attr(musl_not_time64, allow(deprecated))]
    #[cfg_attr(musl_time64, link_name = "__time64")]
    pub fn time(time: *mut time_t) -> time_t;
    #[cfg_attr(target_os = "netbsd", link_name = "__gmtime50")]
    #[cfg_attr(musl_not_time64, allow(deprecated))]
    #[cfg_attr(musl_time64, link_name = "__gmtime64")]
    pub fn gmtime(time_p: *const time_t) -> *mut tm;
    #[cfg_attr(target_os = "netbsd", link_name = "__locatime50")]
    #[cfg_attr(musl_not_time64, allow(deprecated))]
    #[cfg_attr(musl_time64, link_name = "__localtime64")]
    pub fn localtime(time_p: *const time_t) -> *mut tm;
    #[cfg_attr(target_os = "netbsd", link_name = "__difftime50")]
    #[cfg_attr(musl_not_time64, allow(deprecated))]
    #[cfg_attr(musl_time64, link_name = "__difftime64")]
...
cfg_if! {
    if #[cfg(not(any(
        ...
        extern "C" {
            #[cfg_attr(musl_time64, link_name = "__adjtime64")]
