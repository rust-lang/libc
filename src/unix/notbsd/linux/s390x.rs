...
pub const SYS_restart_syscall: ::c_ulong = 7;
...
pub const SYS_lookup_dcookie: ::c_ulong = 110;
...
pub const SYS_query_module: ::c_ulong = 167;
...
pub const SYS_getpmsg: ::c_ulong = 188;
pub const SYS_putpmsg: ::c_ulong = 189;
pub const SYS_vfork: ::c_ulong = 190;
pub const SYS_pivot_root: ::c_ulong = 217;
pub const SYS_mincore: ::c_ulong = 218;
pub const SYS_madvise: ::c_ulong = 219;
pub const SYS_getdents64: ::c_ulong = 220;
pub const SYS_readahead: ::c_ulong = 222;
pub const SYS_setxattr: ::c_ulong = 224;
pub const SYS_lsetxattr: ::c_ulong = 225;
pub const SYS_fsetxattr: ::c_ulong = 226;
pub const SYS_getxattr: ::c_ulong = 227;
pub const SYS_lgetxattr: ::c_ulong = 228;
pub const SYS_fgetxattr: ::c_ulong = 229;
pub const SYS_listxattr: ::c_ulong = 230;
pub const SYS_llistxattr: ::c_ulong = 231;
pub const SYS_flistxattr: ::c_ulong = 232;
pub const SYS_removexattr: ::c_ulong = 233;
pub const SYS_lremovexattr: ::c_ulong = 234;
pub const SYS_fremovexattr: ::c_ulong = 235;
pub const SYS_gettid: ::c_ulong = 236;
pub const SYS_tkill: ::c_ulong = 237;
pub const SYS_futex: ::c_ulong = 238;
pub const SYS_sched_setaffinity: ::c_ulong = 239;
pub const SYS_sched_getaffinity: ::c_ulong = 240;
pub const SYS_tgkill: ::c_ulong = 241;
...
pub const SYS_epoll_create: ::c_ulong = 249;
pub const SYS_epoll_ctl: ::c_ulong = 250;
pub const SYS_epoll_wait: ::c_ulong = 251;
pub const SYS_set_tid_address: ::c_ulong = 252;
pub const SYS_fadvise64: ::c_ulong = 253;
pub const SYS_timer_create: ::c_ulong = 254;
pub const SYS_timer_settime: ::c_ulong = 255;
pub const SYS_timer_gettime: ::c_ulong = 256;
pub const SYS_timer_getoverrun: ::c_ulong = 257;
pub const SYS_timer_delete: ::c_ulong = 258;
pub const SYS_clock_settime: ::c_ulong = 259;
pub const SYS_clock_gettime: ::c_ulong = 260;
pub const SYS_clock_getres: ::c_ulong = 261;
pub const SYS_clock_nanosleep: ::c_ulong = 262;
pub const SYS_statfs64: ::c_ulong = 265;
pub const SYS_fstatfs64: ::c_ulong = 266;
pub const SYS_remap_file_pages: ::c_ulong = 267;
pub const SYS_mbind: ::c_ulong = 268;
pub const SYS_get_mempolicy: ::c_ulong = 269;
pub const SYS_set_mempolicy: ::c_ulong = 270;
pub const SYS_mq_open: ::c_ulong = 271;
pub const SYS_mq_unlink: ::c_ulong = 272;
pub const SYS_mq_timedsend: ::c_ulong = 273;
pub const SYS_mq_timedreceive: ::c_ulong = 274;
pub const SYS_mq_notify: ::c_ulong = 275;
pub const SYS_mq_getsetattr: ::c_ulong = 276;
pub const SYS_kexec_load: ::c_ulong = 277;
pub const SYS_add_key: ::c_ulong = 278;
pub const SYS_request_key: ::c_ulong = 279;
pub const SYS_keyctl: ::c_ulong = 280;
pub const SYS_waitid: ::c_ulong = 281;
pub const SYS_ioprio_set: ::c_ulong = 282;
pub const SYS_ioprio_get: ::c_ulong = 283;
pub const SYS_inotify_init: ::c_ulong = 284;
pub const SYS_inotify_add_watch: ::c_ulong = 285;
pub const SYS_inotify_rm_watch: ::c_ulong = 286;
pub const SYS_migrate_pages: ::c_ulong = 287;
pub const SYS_openat: ::c_ulong = 288;
pub const SYS_mkdirat: ::c_ulong = 289;
pub const SYS_mknodat: ::c_ulong = 290;
pub const SYS_fchownat: ::c_ulong = 291;
pub const SYS_futimesat: ::c_ulong = 292;
pub const SYS_unlinkat: ::c_ulong = 294;
pub const SYS_renameat: ::c_ulong = 295;
pub const SYS_linkat: ::c_ulong = 296;
pub const SYS_symlinkat: ::c_ulong = 297;
pub const SYS_readlinkat: ::c_ulong = 298;
pub const SYS_fchmodat: ::c_ulong = 299;
pub const SYS_faccessat: ::c_ulong = 300;
pub const SYS_pselect6: ::c_ulong = 301;
pub const SYS_ppoll: ::c_ulong = 302;
pub const SYS_unshare: ::c_ulong = 303;
pub const SYS_set_robust_list: ::c_ulong = 304;
pub const SYS_get_robust_list: ::c_ulong = 305;
pub const SYS_splice: ::c_ulong = 306;
pub const SYS_sync_file_range: ::c_ulong = 307;
pub const SYS_tee: ::c_ulong = 308;
pub const SYS_vmsplice: ::c_ulong = 309;
pub const SYS_move_pages: ::c_ulong = 310;
pub const SYS_getcpu: ::c_ulong = 311;
pub const SYS_epoll_pwait: ::c_ulong = 312;
pub const SYS_utimes: ::c_ulong = 313;
pub const SYS_fallocate: ::c_ulong = 314;
pub const SYS_utimensat: ::c_ulong = 315;
pub const SYS_signalfd: ::c_ulong = 316;
pub const SYS_timerfd: ::c_ulong = 317;
pub const SYS_eventfd: ::c_ulong = 318;
pub const SYS_timerfd_create: ::c_ulong = 319;
pub const SYS_timerfd_settime: ::c_ulong = 320;
pub const SYS_timerfd_gettime: ::c_ulong = 321;
pub const SYS_signalfd4: ::c_ulong = 322;
pub const SYS_eventfd2: ::c_ulong = 323;
pub const SYS_inotify_init1: ::c_ulong = 324;
pub const SYS_pipe2: ::c_ulong = 325;
pub const SYS_dup3: ::c_ulong = 326;
pub const SYS_epoll_create1: ::c_ulong = 327;
pub const SYS_preadv: ::c_ulong = 328;
pub const SYS_pwritev: ::c_ulong = 329;
pub const SYS_rt_tgsigqueueinfo: ::c_ulong = 330;
pub const SYS_perf_event_open: ::c_ulong = 331;
pub const SYS_fanotify_init: ::c_ulong = 332;
pub const SYS_fanotify_mark: ::c_ulong = 333;
pub const SYS_prlimit64: ::c_ulong = 334;
pub const SYS_name_to_handle_at: ::c_ulong = 335;
pub const SYS_open_by_handle_at: ::c_ulong = 336;
pub const SYS_clock_adjtime: ::c_ulong = 337;
pub const SYS_syncfs: ::c_ulong = 338;
pub const SYS_setns: ::c_ulong = 339;
pub const SYS_process_vm_readv: ::c_ulong = 340;
pub const SYS_process_vm_writev: ::c_ulong = 341;
pub const SYS_s390_runtime_instr: ::c_ulong = 342;
pub const SYS_kcmp: ::c_ulong = 343;
pub const SYS_finit_module: ::c_ulong = 344;
pub const SYS_sched_setattr: ::c_ulong = 345;
pub const SYS_sched_getattr: ::c_ulong = 346;
pub const SYS_renameat2: ::c_ulong = 347;
pub const SYS_seccomp: ::c_ulong = 348;
pub const SYS_getrandom: ::c_ulong = 349;
pub const SYS_memfd_create: ::c_ulong = 350;
pub const SYS_bpf: ::c_ulong = 351;
pub const SYS_s390_pci_mmio_write: ::c_ulong = 352;
pub const SYS_s390_pci_mmio_read: ::c_ulong = 353;
pub const SYS_execveat: ::c_ulong = 354;
pub const SYS_userfaultfd: ::c_ulong = 355;
pub const SYS_membarrier: ::c_ulong = 356;
pub const SYS_recvmmsg: ::c_ulong = 357;
pub const SYS_sendmmsg: ::c_ulong = 358;
pub const SYS_socket: ::c_ulong = 359;
pub const SYS_socketpair: ::c_ulong = 360;
pub const SYS_bind: ::c_ulong = 361;
pub const SYS_connect: ::c_ulong = 362;
pub const SYS_listen: ::c_ulong = 363;
pub const SYS_accept4: ::c_ulong = 364;
pub const SYS_getsockopt: ::c_ulong = 365;
pub const SYS_setsockopt: ::c_ulong = 366;
pub const SYS_getsockname: ::c_ulong = 367;
pub const SYS_getpeername: ::c_ulong = 368;
pub const SYS_sendto: ::c_ulong = 369;
pub const SYS_sendmsg: ::c_ulong = 370;
pub const SYS_recvfrom: ::c_ulong = 371;
pub const SYS_recvmsg: ::c_ulong = 372;
pub const SYS_shutdown: ::c_ulong = 373;
pub const SYS_mlock2: ::c_ulong = 374;
pub const SYS_copy_file_range: ::c_ulong = 375;
pub const SYS_preadv2: ::c_ulong = 376;
pub const SYS_pwritev2: ::c_ulong = 377;
...
pub const SYS_select: ::c_ulong = 142;
pub const SYS_getegid: ::c_ulong = 202;
pub const SYS_setgroups: ::c_ulong = 206;
pub const SYS_getresuid: ::c_ulong = 209;
pub const SYS_chown: ::c_ulong = 212;
pub const SYS_setfsuid: ::c_ulong = 215;
pub const SYS_setfsgid: ::c_ulong = 216;
pub const SYS_newfstatat: ::c_ulong = 293;
