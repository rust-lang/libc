...
s_no_extra_traits! {
    ...
    pub struct tcp_info {
        ...
        /// This is actually a bool using the LSB
    ...
    if #[cfg(feature = "extra_traits")] {
        ...
        impl PartialEq for tcp_info {
            fn eq(&self, other: &tcp_info) -> bool {
                ...
                self.tcpi_wscale == other.tcpi_wscale &&
                // This is a single-bit bitfield, so we should only compare the
                // actually relevant bit.
                (self.tcpi_delivery_rate_app_limited & 1) ==
                    (other.tcpi_delivery_rate_app_limited & 1) &&
