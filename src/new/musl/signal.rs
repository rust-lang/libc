...
//!
//! * Headers: <https://git.musl-libc.org/cgit/musl/tree/include/signal.h?id=b306b16af15c89a04d8e0c55cac2dadbeb39c083> (official)
//! * Headers: <https://github.com/kraj/musl/blob/a42e9dee266f398026a33d0793c66225c7997755/include/signal.h> (mirror)
...
impl siginfo_t {
    ...
    pub unsafe fn si_pid(&self) -> crate::pid_t {
        self.__si_fields.__si_common.__first.__piduid.si_pid
    }

    #[inline]
    pub unsafe fn si_uid(&self) -> crate::uid_t {
        self.__si_fields.__si_common.__first.__piduid.si_uid
    }

    #[inline]
    pub unsafe fn si_status(&self) -> c_int {
        self.__si_fields.__si_common.__second.__sigchld.si_status
    }

    #[inline]
    pub unsafe fn si_utime(&self) -> crate::clock_t {
        self.__si_fields.__si_common.__second.__sigchld.si_utime
    }

    #[inline]
    pub unsafe fn si_stime(&self) -> crate::clock_t {
        self.__si_fields.__si_common.__second.__sigchld.si_stime
    }

    #[inline]
    pub unsafe fn si_value(&self) -> crate::sigval {
        self.__si_fields.__si_common.__second.si_value
    }

    #[inline]
    pub unsafe fn si_addr(&self) -> *mut c_void {
        self.__si_fields.__sigfault.si_addr
    }

    #[inline]
    pub unsafe fn si_addr_lsb(&self) -> c_short {
        self.__si_fields.__sigfault.si_addr_lsb
    }

    #[inline]
    pub unsafe fn si_lower(&self) -> *mut c_void {
        self.__si_fields.__sigfault.__first.__addr_band.si_lower
    }

    #[inline]
    pub unsafe fn si_upper(&self) -> *mut c_void {
        self.__si_fields.__sigfault.__first.__addr_band.si_upper
    }

    #[inline]
    pub unsafe fn si_pkey(&self) -> c_uint {
        self.__si_fields.__sigfault.__first.si_pkey
    }

    #[inline]
    pub unsafe fn si_band(&self) -> c_long {
        self.__si_fields.__sigpoll.si_band
    }

    #[inline]
    pub unsafe fn si_fd(&self) -> c_int {
        self.__si_fields.__sigpoll.si_fd
    }

    #[inline]
    pub unsafe fn si_timerid(&self) -> c_int {
        self.__si_fields.__si_common.__first.__timer.si_timerid
    }

    #[inline]
    pub unsafe fn si_overrun(&self) -> c_int {
        self.__si_fields.__si_common.__first.__timer.si_overrun
    }

    #[inline]
    pub unsafe fn si_ptr(&self) -> *mut c_void {
        self.__si_fields.__si_common.__second.si_value.sival_ptr
    }

    #[inline]
    pub unsafe fn si_int(&self) -> c_int {
        self.__si_fields.__si_common.__second.si_value.sival_int
    }

    #[inline]
    pub unsafe fn si_call_addr(&self) -> *mut c_void {
        self.__si_fields.__sigsys.si_call_addr
    }

    #[inline]
    pub unsafe fn si_syscall(&self) -> c_int {
        self.__si_fields.__sigsys.si_syscall
    }

    #[inline]
    pub unsafe fn si_arch(&self) -> c_uint {
        self.__si_fields.__sigsys.si_arch
    }
}
