...
//!
//! This mirrors one-to-one the generic definition. See the `#[path]` redirects
//! in the `super` module for the architecture-specific definitions. Unlike
//! upstream, they override this entire module, and not just specific fields of
//! `siginfo_t`.
//!
